import {
  ...
  Search, ChevronUp, ChevronDown, ArrowLeft, ArrowRight, Settings, LogOut, CreditCard, Bell, Filter, RefreshCw, BarChart3, FileText, LockKeyhole, Smartphone, Globe2, ShieldCheck, Pencil, Trash2, ExternalLink, GripVertical, Users, Plus, School, Link2,
} from 'lucide-react';
...
const ICON_MAP = {
  ...
  lock: LockKeyhole, android: Smartphone, web: Globe2, secure: ShieldCheck, edit: Pencil, trash: Trash2, externalLink: ExternalLink, grip: GripVertical, users: Users, plus: Plus, school: School, link: Link2,
};
