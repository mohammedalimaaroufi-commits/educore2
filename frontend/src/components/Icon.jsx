import {
  ...
  Search, ChevronUp, ChevronDown, Settings, LogOut, CreditCard, Bell, Filter, RefreshCw, BarChart3, FileText, LayoutDashboard, LockKeyhole, Smartphone, Globe2, ShieldCheck, Pencil, Trash2, ExternalLink,
} from 'lucide-react';
...
const ICON_MAP = {
  ...
  settings: Settings, logout: LogOut, subscription: CreditCard, bell: Bell, filter: Filter, refresh: RefreshCw, analytics: BarChart3, reports: FileText, dashboard: LayoutDashboard,
  lock: LockKeyhole, android: Smartphone, web: Globe2, secure: ShieldCheck, edit: Pencil, trash: Trash2, externalLink: ExternalLink,
};
