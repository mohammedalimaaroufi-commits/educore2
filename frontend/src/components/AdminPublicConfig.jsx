...
export default function AdminPublicConfig() {
  ...
  return <form className="admin-public-config" onSubmit={save}>
    ...
    {section === 'announcement' && <section className="admin-config-card admin-config-card--announcement">
    ...
    {section === 'notifications' && <section className="admin-config-card admin-config-card--notifications">
