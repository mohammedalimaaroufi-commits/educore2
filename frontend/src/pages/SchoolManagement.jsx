...
export default function SchoolManagement() {
  ...
  const generateCode = async (classId, className = '') => {
    if (busy) return;
    ...
    try {
      ...
      const codeData = { ...data, class_name: className };
      setGeneratedCodes((current) => ({ ...current, [classId]: codeData }));
