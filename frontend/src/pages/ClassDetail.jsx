    ...
    <div className="class-page-shell" dir={direction}>
      <div className="class-page-fixed-header">
        ...
        {cls && <header className="class-page-header" style={{ '--class-accent': cls.color || '#2E7D6B' }}>
          <div className="class-page-header__visual"><span className="class-page-header__symbol class-page-header__symbol--logo"><img src="/educore-logo.webp" alt="EduCore" /></span><span className="class-page-header__eyebrow">{isArabic ? 'مساحة الصف' : 'Class workspace'}</span><h1>{cls.name}</h1><p>{cls.subject || (isArabic ? 'مادة غير محددة' : 'Subject not specified')} {cls.academic_year ? `• ${cls.academic_year}` : ''}</p></div>
